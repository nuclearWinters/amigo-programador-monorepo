...
export type CommentsPaginationModuleResponse = {
    readonly node: {
        readonly " $fragmentRefs": FragmentRefs<"Comments_module">;
    } | null;
};
export type CommentsPaginationModule = {
    readonly response: CommentsPaginationModuleResponse;
    readonly variables: CommentsPaginationModuleVariables;
};



/*
query CommentsPaginationModule(
  $count: Int = 5
  $cursor: String = ""
  $id: ID!
) {
