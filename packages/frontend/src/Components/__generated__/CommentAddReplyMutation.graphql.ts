...
export type CommentAddReplyMutationResponse = {
    readonly addReply: {
...
export type CommentAddReplyMutation = {
    readonly response: CommentAddReplyMutationResponse;
    readonly variables: CommentAddReplyMutationVariables;
};



/*
mutation CommentAddReplyMutation(
  $input: AddReplyInput!
) {
