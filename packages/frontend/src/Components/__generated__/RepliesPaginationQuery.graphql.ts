...
export type RepliesPaginationQueryVariables = {
    count?: number | null | undefined;
    cursor?: string | null | undefined;
    id: string;
};
export type RepliesPaginationQueryResponse = {
    readonly node: {
        readonly " $fragmentRefs": FragmentRefs<"Replies_query">;
    } | null;
};
export type RepliesPaginationQuery = {
    readonly response: RepliesPaginationQueryResponse;
    readonly variables: RepliesPaginationQueryVariables;
};
