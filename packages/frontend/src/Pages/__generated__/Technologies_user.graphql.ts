...
export type Technologies_user = {
    ...
    readonly " $refType": "Technologies_user";
};
export type Technologies_user$data = Technologies_user;
export type Technologies_user$key = {
    readonly " $data"?: Technologies_user$data | undefined;
    readonly " $fragmentRefs": FragmentRefs<"Technologies_user">;
};
