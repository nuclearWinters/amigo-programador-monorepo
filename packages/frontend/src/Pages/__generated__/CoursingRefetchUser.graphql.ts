/**
 * @generated SignedSource<<3a7e09475b0b0a8dde589af6e14dd931>>
...
export type CoursingRefetchUser$variables = {
  module_gid?: string | null;
  technology_gid?: string | null;
  id: string;
};
export type CoursingRefetchUserVariables = CoursingRefetchUser$variables;
export type CoursingRefetchUser$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"Coursing_user">;
  } | null;
};
export type CoursingRefetchUserResponse = CoursingRefetchUser$data;
export type CoursingRefetchUser = {
  variables: CoursingRefetchUserVariables;
  response: CoursingRefetchUser$data;
};
