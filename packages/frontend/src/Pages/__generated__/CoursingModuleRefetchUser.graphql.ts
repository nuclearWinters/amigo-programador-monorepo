...
export type CoursingModuleRefetchUserResponse = {
    readonly node: {
        readonly " $fragmentRefs": FragmentRefs<"CoursingModule_user">;
    } | null;
};
export type CoursingModuleRefetchUser = {
    readonly response: CoursingModuleRefetchUserResponse;
    readonly variables: CoursingModuleRefetchUserVariables;
};



/*
query CoursingModuleRefetchUser(
  $module_gid: ID
  $id: ID!
) {
  node(id: $id) {
